...
``drop_view`` keep the views a read may name. After every step the recorder
...
def _read(session: Session, method: str, params: dict[str, Any]) -> BaseModel:
    ...
    def _apply(self, step: dict[str, Any]) -> Any:
        ...
        match step["do"]:
            ...
            case "read":
                ...
                body = _read(session, step["method"], step["params"])
